...
any of them for its name and shortcut; the order is play/pause, next, random,
mutate, fit, keep, stream, clear, the quality preset, the details overlay, fullscreen
and the handbook.
