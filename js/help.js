  ...
  var SECTIONS = [
    ...
    },
    {
      ...
      html: [
        ...
        'of them for its name and shortcut; the order is play/pause, random, mutate, fit, keep, stream,',
        'clear, the quality preset, the details overlay, fullscreen and the handbook.</p>',
